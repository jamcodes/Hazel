...
macro(SetGlobalFlags)
    ...
    set(CMAKE_RUNTIME_OUTPUT_DIRECTORY                ${CMAKE_SOURCE_DIR}/bin/${CMAKE_BUILD_TYPE}-${CMAKE_SYSTEM_NAME}${_setglobalflags_arch})
    set(CMAKE_RUNTIME_OUTPUT_DIRECTORY_DEBUG          ${CMAKE_SOURCE_DIR}/bin/Debug-${CMAKE_SYSTEM_NAME}${_setglobalflags_arch})
    set(CMAKE_RUNTIME_OUTPUT_DIRECTORY_RELWITHDEBINFO ${CMAKE_SOURCE_DIR}/bin/Release-${CMAKE_SYSTEM_NAME}${_setglobalflags_arch})
    set(CMAKE_RUNTIME_OUTPUT_DIRECTORY_RELEASE        ${CMAKE_SOURCE_DIR}/bin/Dist-${CMAKE_SYSTEM_NAME}${_setglobalflags_arch})
    set(CMAKE_ARCHIVE_OUTPUT_DIRECTORY                ${CMAKE_SOURCE_DIR}/bin-int/${CMAKE_BUILD_TYPE}-${CMAKE_SYSTEM_NAME}${_setglobalflags_arch})
    set(CMAKE_ARCHIVE_OUTPUT_DIRECTORY_DEBUG          ${CMAKE_SOURCE_DIR}/bin-int/Debug-${CMAKE_SYSTEM_NAME}${_setglobalflags_arch})
    set(CMAKE_ARCHIVE_OUTPUT_DIRECTORY_RELWITHDEBINFO ${CMAKE_SOURCE_DIR}/bin-int/Release-${CMAKE_SYSTEM_NAME}${_setglobalflags_arch})
    set(CMAKE_ARCHIVE_OUTPUT_DIRECTORY_RELEASE        ${CMAKE_SOURCE_DIR}/bin-int/Dist-${CMAKE_SYSTEM_NAME}${_setglobalflags_arch})
    set(CMAKE_LIBRARY_OUTPUT_DIRECTORY                ${CMAKE_SOURCE_DIR}/bin-int/${CMAKE_BUILD_TYPE}-${CMAKE_SYSTEM_NAME}${_setglobalflags_arch})
    set(CMAKE_LIBRARY_OUTPUT_DIRECTORY_DEBUG          ${CMAKE_SOURCE_DIR}/bin-int/Debug-${CMAKE_SYSTEM_NAME}${_setglobalflags_arch})
    set(CMAKE_LIBRARY_OUTPUT_DIRECTORY_RELWITHDEBINFO ${CMAKE_SOURCE_DIR}/bin-int/Release-${CMAKE_SYSTEM_NAME}${_setglobalflags_arch})
    set(CMAKE_LIBRARY_OUTPUT_DIRECTORY_RELEASE        ${CMAKE_SOURCE_DIR}/bin-int/Dist-${CMAKE_SYSTEM_NAME}${_setglobalflags_arch})
    unset(_setglobalflags_arch)
endmacro()
