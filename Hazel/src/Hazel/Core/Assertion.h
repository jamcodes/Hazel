...
#define HZ_CONTRACT_LEVEL_CONFIG CONTRACT_CONCATENATE(CONTRACT_LEVEL_DEFINE_, HZ_CONTRACT_LEVEL)  // -D HZ_CONTRACT_LEVEL=ASSUME
#else
#define HZ_CONTRACT_LEVEL_CONFIG CONTRACT_CONCATENATE(CONTRACT_LEVEL_DEFINE_, ASSUME)
#endif
#endif
...
#if HZ_CONTRACT_LEVEL_CONFIG > CONTRACT_LEVEL_DEFINE_IGNORED
