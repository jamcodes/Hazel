...
namespace Hazel {
void LayerStack::pushLayer(value_type layer) { layers_.emplace(layerInsert_, std::move(layer)); }

void LayerStack::pushOverlay(value_type overlay) { layers_.emplace_back(std::move(overlay)); }
